<?php
	...
	if ($USER->id == 2) {
		...
		//} else {
		//	$sqlalumno .= " AND ((mdl_user.id>19000) and (mdl_user.id<19010))";	
		//}
		...
		foreach ($listado_alumnos as $alumno) {
			$contenido_email =  "<p>Buenos d&iacute;as " . $alumno->firstname . " " . $alumno->lastname .",</p>";
			...
			$contenido_email .= "<p>Necesitar&aacute;s como mucho <strong>30 minutos, y deber&aacute;s entrar justo el d&iacute;a 7 de mayo a las 16.00 horas</strong>. Si ese d&iacute;a no puedes entar, no pasa nada, haremos 2 pruebas, y en cada una os convocamos a m&aacute;s del triple de usuarios que entrareis en la Plataforma de los estimados en los ex&aacute;manes convocados para este fin de curso. De esta manera, se podr&aacute; comunicar a AST (alojan el Servidor de la Plataforma) cualquier necesidad o problema con el Servidor.</p>";
            $contenido_email .= "<ul>
								<li>1. <strong>Entra en la Plataforma el d&iacute;a 7 a las 16.00 horas con tus datos de acceso:</strong>

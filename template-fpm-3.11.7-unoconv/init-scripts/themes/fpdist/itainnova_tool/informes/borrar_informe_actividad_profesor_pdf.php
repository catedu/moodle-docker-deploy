...
if(has_capability('moodle/site:config', $coursecontext)) {
	...
	if($categoria==NULL || $categoria == 0){
		...
		$quecurso = "SELECT id,fullname,category FROM mdl_course WHERE category not in (0,18,26,27,38,52,55) AND category = $categoria AND shortname not like '%\_TU' order by mdl_course.id";

...
if (empty($_POST)){
	...
	?>
	<div style="width:90%;">
	<h2>Elige una Encuesta:</h2>
	<p>Las finalizadas en a son de Alumnos<br>Las finalizadas en p Profesores<br></p>
	<form action="informe_encuesta.php" style="width:50%;margin-left:5%" method="post">
	<select  id='id_encuesta' style="width:100%" name='id_encuesta' >
	<option value=0>Por favor selecciona la encuesta ...</option>
	<?php
	...
	//Obtenemos los datos
	$data = $DB->get_records_sql("SELECT * FROM encuesta_datos WHERE encuesta = '".$_POST['id_encuesta']."' ORDER BY encuesta");
	//Si existen datos
	if(count($data)){

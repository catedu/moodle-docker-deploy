...
if (is_siteadmin()) {
    ...
    $ADMIN->add('qtype_gapfill_category', $settingspage);
     $settingspage->add(new admin_setting_configcheckbox(
         'qtype_gapfill/disableregex',
         get_string('disableregex', 'qtype_gapfill'),
         get_string('disableregexset_text', 'qtype_gapfill'),
         1
     ));
    $settingspage->add(new admin_setting_configcheckbox(
        'qtype_gapfill/singleuse',
        get_string('singleuse', 'qtype_gapfill'),
        get_string('singleuse_text', 'qtype_gapfill'),
        0
    ));
    $settingspage->add(new admin_setting_configcheckbox(
        'qtype_gapfill/fixedgapsize',
        get_string('fixedgapsize', 'qtype_gapfill'),
        get_string('fixedgapsizeset_text', 'qtype_gapfill'),
        1
    ));
    $settingspage->add(new admin_setting_configcheckbox(
        'qtype_gapfill/casesensitive',
        get_string('casesensitive', 'qtype_gapfill'),
        get_string('casesensitive_help', 'qtype_gapfill'),
        0
    ));
    $settingspage->add(new admin_setting_configcheckbox(
        'qtype_gapfill/optionsaftertext',
        get_string('optionsaftertext', 'qtype_gapfill'),
        get_string('optionsaftertext_text', 'qtype_gapfill'),
        0
    ));
    $settingspage->add(new admin_setting_configcheckbox(
        'qtype_gapfill/letterhints',
        get_string('letterhints', 'qtype_gapfill'),
        get_string('letterhints_text', 'qtype_gapfill'),
        0
    ));
    $settingspage->add(new admin_setting_configcheckbox(
        'qtype_gapfill/addhinttext',
        get_string('addhinttext', 'qtype_gapfill'),
        get_string('addhinttext_text', 'qtype_gapfill'),
        0
    ));
    $settingspage->add(new admin_setting_configtextarea(
        'qtype_gapfill/delimitchars',

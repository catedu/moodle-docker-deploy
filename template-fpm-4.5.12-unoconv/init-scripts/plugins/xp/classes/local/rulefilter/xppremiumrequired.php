 ...
 */
abstract class xppremiumrequired implements has_availability_info, rulefilter {

    public function get_availability_info(): availability_info {
        return new static_info(false, [new unavailability('xppremiumrequired', new \lang_string('xppremiumrequired', 'block_xp'))]);
    }

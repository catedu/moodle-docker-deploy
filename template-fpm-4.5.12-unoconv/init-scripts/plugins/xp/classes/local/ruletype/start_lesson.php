...
use block_xp\local\reason\lesson_started_reason;
 ...
 */
class start_lesson implements ruletype, ruletype_with_goal, ruletype_with_limit, ruletype_with_profile, with_iconography {
    ...
    public function get_display_name(): lang_string {
        return new lang_string('ruletypestartlesson', 'block_xp');
    }
    ...
    public function get_short_description(): lang_string {
        return new lang_string('ruletypestartlessondesc', 'block_xp');
    }
    ...
    public function make_reason(action $action): reason {
        $reason = new lesson_started_reason();

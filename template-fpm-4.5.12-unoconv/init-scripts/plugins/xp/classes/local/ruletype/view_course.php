...
use block_xp\local\reason\course_viewed_reason;
 ...
 */
class view_course implements ruletype, ruletype_with_goal, ruletype_with_limit, ruletype_with_profile, with_iconography {
    ...
    public function get_display_name(): lang_string {
        return new lang_string('ruletypeviewcourse', 'block_xp');
    }
    ...
    public function get_short_description(): lang_string {
        return new lang_string('ruletypeviewcoursedesc', 'block_xp');
    }

    public function is_action_compatible(action $action): bool {
        return $action->get_type() === 'course_viewed';
    }
    ...
    public function make_reason(action $action): reason {
        $reason = new course_viewed_reason();

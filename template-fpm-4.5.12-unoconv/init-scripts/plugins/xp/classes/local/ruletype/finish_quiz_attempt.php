...
use block_xp\local\reason\quiz_attempt_finished_reason;
 ...
 */
class finish_quiz_attempt implements ruletype, ruletype_with_goal, ruletype_with_limit, ruletype_with_profile, with_iconography {
    ...
    public function get_display_name(): lang_string {
        return new lang_string('ruletypefinishquizattempt', 'block_xp');
    }
    ...
    public function get_short_description(): lang_string {
        return new lang_string('ruletypefinishquizattemptdesc', 'block_xp');
    }

    public function is_action_compatible(action $action): bool {
        return $action->get_type() === 'quiz_attempt_submitted';
    }
    ...
    public function make_reason(action $action): reason {
        $reason = new quiz_attempt_finished_reason();

...
use block_xp\local\reason\glossary_entry_published_reason;
 ...
 */
class publish_glossary_entry implements ruletype, ruletype_with_goal, ruletype_with_limit, ruletype_with_profile, with_iconography {
    ...
    public function get_display_name(): lang_string {
        return new lang_string('ruletypepublishglossaryentry', 'block_xp');
    }
    ...
    public function get_profile(): profile {
        return new cm_profile('glossary');
    }

    public function get_short_description(): lang_string {
        return new lang_string('ruletypepublishglossaryentrydesc', 'block_xp');
    }

    public function is_action_compatible(action $action): bool {
        return $action->get_type() === 'glossary_entry_published';
    }
    ...
    public function make_reason(action $action): reason {
        $reason = new glossary_entry_published_reason();

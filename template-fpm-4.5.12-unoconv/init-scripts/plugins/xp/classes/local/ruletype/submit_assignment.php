...
use block_xp\local\reason\assign_submitted_reason;
 ...
 */
class submit_assignment implements ruletype, ruletype_with_goal, ruletype_with_limit, ruletype_with_profile, with_iconography {
    ...
    public function get_display_name(): lang_string {
        return new lang_string('ruletypesubmitassignment', 'block_xp');
    }
    ...
    public function get_short_description(): lang_string {
        return new lang_string('ruletypesubmitassignmentdesc', 'block_xp');
    }

    public function is_action_compatible(action $action): bool {
        return $action->get_type() === 'assign_submission_submitted';
    }
    ...
    public function make_reason(action $action): reason {
        $reason = new assign_submitted_reason();

...
use block_xp\local\reason\lesson_end_reached_reason;
 ...
 */
class reach_lesson_end implements ruletype, ruletype_with_goal, ruletype_with_limit, ruletype_with_profile, with_iconography {
    ...
    public function get_display_name(): lang_string {
        return new lang_string('ruletypereachlessonend', 'block_xp');
    }
    ...
    public function get_icon(): ?icon {
        return new fa_icon('flag-checkered');
    }
    ...
    public function get_short_description(): lang_string {
        return new lang_string('ruletypereachlessonenddesc', 'block_xp');
    }
    ...
    public function make_reason(action $action): reason {
        $reason = new lesson_end_reached_reason();

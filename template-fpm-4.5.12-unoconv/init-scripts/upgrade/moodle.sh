...
moosh config-set indentation 1 format_topics 
...
#Deshabilitamos moodlenet porque deja de dar servicio desde 20-04-2026
moosh config-set enablemoodlenet 0 tool_moodlenet
moosh config-set activitychooseractivefooter hidden
#Añadimos grabación de pantalla

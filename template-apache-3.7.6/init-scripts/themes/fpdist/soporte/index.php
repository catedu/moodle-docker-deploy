                                            ...
                                            <div class="settingsform">
                                                ...
                                                <fieldset>
                                                        ...
                                                        <div class="form-setting col-sm-9">
                                                            <div class="form-select defaultsnext">
                                                                <select  id="ciclo" name="ciclo" class="custom-select" required>
                                                                    ...
                                                                    <option value="IES Martínez Vargas  : Educación Infantil (IES Martínez Vargas)">IES Martínez Vargas  : Educación Infantil (IES Martínez Vargas)</option>
                                                        ...
                                                        <div class="form-setting col-sm-9">
                                                            <div class="form-select defaultsnext">
                                                                <select  id="motivo" name="motivo" class="custom-select" required>
                                                                    ...
                                                                    <option value="4" >Dar de alta/baja profesorado</option>
                                                    ...
                                                    <div id="capaDocente">
                                                        ...
                                                        <div class="form-item row">
                                                            <div class="form-label col-sm-3 text-sm-right">
                                                                <label for="sape_docente">2º apellido de docente a crear</label>
                                                            </div>
                                                            <div class="form-setting col-sm-9">
                                                                <div class="form-text defaultsnext">

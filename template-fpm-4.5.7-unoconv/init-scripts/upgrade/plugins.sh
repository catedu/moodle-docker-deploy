...
moosh plugin-uninstall atto_fontfamily
moosh plugin-uninstall atto_fontsize
moosh plugin-uninstall atto_fullscreen
moosh plugin-uninstall atto_styles
echo >&2 "Plugins atto uninstalled!"

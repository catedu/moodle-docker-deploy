...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/theme/yui_combo.php?rollup/3.17.2/yui-moodlesimple-min.css" />
    <script id="firstthemesheet" type="text/css">
        /** Required in order to fix style inclusion problems in IE with YUI **/
    </script>
    <link rel="stylesheet" type="text/css" href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/theme/styles.php/moove/1615997395_1/all" />
    <meta charset="utf-8">
...
<body id="page-site-index" class="format-site course path-site chrome dir-ltr lang-es yui-skin-sam yui3-skin-sam test-adistanciafparagon-es pagelayout-frontpage course-1 context-2 notloggedin ">
        ...
        <div id="page-header" class="frontpage-guest-header">
            <div class="d-flex flex-wrap">
                <div id="page-navbar">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/">Página Principal</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div role="main">
                                    ...
                                    <form action="action.php" method="post" id="form_soporte" name="form_soporte">
                                        <?php
                                        ...
                                        <div class="settingsform">
                                            ...
                                            <p>Desde el Equipo de Soporte de la Formación Profesional Virtual del Gobierno de Aragón queremos darte el mejor servicio posible ante cualquier incidencia que puedas tener.</p>
                                            <p>En el Bloque de <a href="https://www.fpvirtualaragon.es/course/view.php?id=2" title="Ayuda" target="_blank">"AYUDA"</a> de este Portal , encontrarás varios enlaces con información útil que te puede ayudar a resolver las principales dudas o incidencias técnicas que te surjan.</p>
                                                    ...
                                                    <div class="form-setting col-sm-9">
                                                        <div class="form-select defaultsnext">
                                                            <select id="ciclo" name="ciclo" class="custom-select" required>
                                                                ...
                                                                <option value="Campus Digital FP: Desarrollo de Aplicaciones en Lenguaje Python">Campus Digital FP: Desarrollo de Aplicaciones en Lenguaje Python</option>
                                                                ...
                                                                <option value="IES Sierra de Guara: Ciberseguridad en Entornos de las Tecnologías de la Información">IES Sierra de Guara: Ciberseguridad en Entornos de las Tecnologías de la Información</option>
                                                    ...
                                                    <div class="form-setting col-sm-9">
                                                        <div class="form-select defaultsnext">
                                                            <select id="motivo" name="motivo" class="custom-select" required>
                                                                ...
                                                                <option value="2">Acceso a plataforma moodle (www.fpvirtualaragon.es). Problemas con el usuario y contraseña</option>
                                                                <option value="3">Acceso a los contenidos o módulos</option>
                                                                <option value="6">Cambio / Actualización de Materiales</option>
                                                                <option value="7">Problemas con el correo @fpvirtualaragon.es</option>
                                            ...
                                            ?>
                                                ...
                                                <div class="form-item row">
                                                    ...
                                                    <div class="form-setting col-sm-9">
                                                        <div class="form-text defaultsnext">
                                                            <input type="text" name="captcha_challenge" id="captcha_challenge" value="" pattern="[A-Z]{6}" id="captcha_challenge" class="form-control text-ltr" disabled required>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
    ...
    <script>
        ...
        function repaint(rol, motivo) {
            ...
            if (motivo == "7" || motivo == "2"){
                alert("Si te acabas de matricular, debes tener paciencia, si han pasado 3 o 4 días hábiles desde que te matriculaste y no has recibido ningún correo entonces continúa con la incidencia.");
            }
        ...
        document.getElementById("adjunto").onchange = function() {
            ...
            if (!file.type.match('image.*')) {
                alert('El fichero elegido no es un tipo de imagen válido.');
                return;
            }
            //
            ...
            // Open the connection
            xhr.open('POST', 'https://www.fpvirtualaragon.es/soporte/upload.php', true);

...
echo >&2 "Prohibit viewdetailes for students"
...
# Configuramos los enlaces de descarga de las apps. Añadido en moodle4
...
#Añadir campos CDD en perfil usuario 
moosh -n userprofilefields-import /init-scripts/themes/user_profile_fields.csv


#Añadido para moodle4.5
#Deshabilitar moodlenet por dejar de dar servicio desde  el 20 de Abril de 2026
echo >&2 "Deactivating MoodleNet"
moosh -n config-set enablemoodlenet 0 tool_moodlenet
moosh -n config-set activitychooseractivefooter hidden

...
moosh category-create -p 23 -v 1 "Bachillerato de Artes"
moosh category-create -p 26 -v 1 "Primero"
moosh category-create -p 26 -v 1 "Segundo"
moosh category-create -p 23 -v 1 "Bachillerato de Ciencias"
moosh category-create -p 29 -v 1 "Primero"
moosh category-create -p 29 -v 1 "Segundo"
moosh category-create -p 23 -v 1 "Bachillerato de Humanidades y CCSS"
moosh category-create -p 32 -v 1 "Primero"
moosh category-create -p 32 -v 1 "Segundo"
...
moosh course-restore /init-scripts/mbzs/122-matematicasi-primero-bach-ies.mbz 30
moosh course-config-set course 230 shortname matematicasi-primero-bach
moosh course-config-set course 230 fullname "Matemáticas I 1º Bach. "

moosh course-restore /init-scripts/mbzs/123-fisica-primero-bach-ies.mbz 30
moosh course-config-set course 231 shortname fisica-primero-bach
moosh course-config-set course 231 fullname "Física y Química 1º Bach. "

moosh course-restore /init-scripts/mbzs/124-biologia-primero-bach-ies.mbz 30
moosh course-config-set course 232 shortname biologia-primero-bach
moosh course-config-set course 232 fullname "Biología y Geología 1º Bach. "

moosh course-restore /init-scripts/mbzs/128-tecnologia-primero-bach-ies.mbz 30
moosh course-config-set course 233 shortname tecnologia-primero-bach
moosh course-config-set course 233 fullname "Tecnología Industrial 1º Bach. "

moosh course-restore /init-scripts/mbzs/126-efisica-primero-bach-ies.mbz 24
moosh course-config-set course 234 shortname efisica-primero-bach
moosh course-config-set course 234 fullname "Educación Física 1º Bach."

moosh course-restore /init-scripts/mbzs/127-cientifica-primero-bach-ies.mbz 24
moosh course-config-set course 235 shortname cientifica-primero-bach
moosh course-config-set course 235 fullname "Cultura Científica 1º Bach. "

moosh course-restore /init-scripts/mbzs/129-lengua-primero-bach-ies.mbz 24
moosh course-config-set course 236 shortname lengua-primero-bach
moosh course-config-set course 236 fullname "Lengua Castellana y Literatura I 1º Bach"

moosh course-restore /init-scripts/mbzs/130-filosofia-primero-bach-ies.mbz 24
moosh course-config-set course 237 shortname filosofia-primero-bach
moosh course-config-set course 237 fullname "Filosofía 1º Bach. "

moosh course-restore /init-scripts/mbzs/131-english-primero-bach-ies.mbz 24
moosh course-config-set course 238 shortname english-primero-bach
moosh course-config-set course 238 fullname "English I 1º Bach."

moosh course-restore /init-scripts/mbzs/132-francais-primero-bach-ies.mbz 24
moosh course-config-set course 239 shortname francais-primero-bach
moosh course-config-set course 239 fullname "Français I 1º Bach."

moosh course-restore /init-scripts/mbzs/133-deutsch-primero-bach-ies.mbz 24
moosh course-config-set course 240 shortname deutsch-primero-bach
moosh course-config-set course 240 fullname "Deutsch I 1º Bach."

moosh course-restore /init-scripts/mbzs/134-tic1-primero-bach-ies.mbz 24
moosh course-config-set course 241 shortname tic1-primero-bach
moosh course-config-set course 241 fullname "Tecnologías de la Información y la Comunicación I 1º Bach."

moosh course-restore /init-scripts/mbzs/135-religion-primero-bach-ies.mbz 24
moosh course-config-set course 242 shortname religion-primero-bach
moosh course-config-set course 242 fullname "Religión 1º Bach. "

moosh course-restore /init-scripts/mbzs/136-ciudadania-primero-bach-ies.mbz 24
moosh course-config-set course 243 shortname ciudadania-primero-bach
moosh course-config-set course 243 fullname "Educación para la ciudadanía y los derechos humanos 1º Bach. "

moosh course-restore /init-scripts/mbzs/137-aragon-primero-bach-ies.mbz 24
moosh course-config-set course 244 shortname aragon-primero-bach
moosh course-config-set course 244 fullname "Historia y Cultura de Aragón 1º Bach."

moosh course-restore /init-scripts/mbzs/138-aragones-primero-bach-ies.mbz 24
moosh course-config-set course 245 shortname aragones-primero-bach
moosh course-config-set course 245 fullname "Aragonés 1º Bach. "

moosh course-restore /init-scripts/mbzs/139-catalan-primero-bach-ies.mbz 24
moosh course-config-set course 246 shortname catalan-primero-bach
moosh course-config-set course 246 fullname "Catalán 1º Bach."

moosh course-restore /init-scripts/mbzs/140-tutoria-primero-bach-ies.mbz 24
moosh course-config-set course 247 shortname tutoria-primero-bach
moosh course-config-set course 247 fullname "Tutoría 1º Bach. "

moosh course-restore /init-scripts/mbzs/154-contemporaneo-ies.mbz 24
moosh course-config-set course 248 shortname contemporaneo
moosh course-config-set course 248 fullname "Historia del Mundo Contemporáneo 1º Bach."

moosh course-restore /init-scripts/mbzs/155-literaturau-primero-bach-ies.mbz 24
moosh course-config-set course 249 shortname literaturau-primero-bach
moosh course-config-set course 249 fullname "Literatura Universal 1º Bach."

moosh course-restore /init-scripts/mbzs/160-anatomiaa-primero-bach-ies.mbz 24
moosh course-config-set course 250 shortname anatomiaa-primero-bach
moosh course-config-set course 250 fullname "Anatomía Aplicada 1º Bach."

moosh course-restore /init-scripts/mbzs/141-equipo-directivo-ies.mbz 36
moosh course-config-set course 251 shortname equipo-directivo
moosh course-config-set course 251 fullname "Equipo directivo"

moosh course-restore /init-scripts/mbzs/142-claustro-ies.mbz 36
moosh course-config-set course 252 shortname claustro
moosh course-config-set course 252 fullname "Claustro"

moosh course-restore /init-scripts/mbzs/143-departamentos-ies.mbz 36
moosh course-config-set course 253 shortname departamentos
moosh course-config-set course 253 fullname "Departamentos"

moosh course-restore /init-scripts/mbzs/144-ccp-ies.mbz 36
moosh course-config-set course 254 shortname ccp
moosh course-config-set course 254 fullname "CCP"

moosh course-restore /init-scripts/mbzs/145-equipos-didacticos-ies.mbz 36
moosh course-config-set course 255 shortname equipos-didacticos
moosh course-config-set course 255 fullname "Equipos didácticos"

moosh course-restore /init-scripts/mbzs/147-matematicasccss-primero-bach-ies.mbz 33
moosh course-config-set course 256 shortname matematicasccss-primero-bach
moosh course-config-set course 256 fullname "Matemáticas aplicadas a las Ciencias Sociales I 1º Bach. "

moosh course-restore /init-scripts/mbzs/148-latin-primero-bach-ies.mbz 33
moosh course-config-set course 257 shortname latin-primero-bach
moosh course-config-set course 257 fullname "Latín I 1º Bach."

moosh course-restore /init-scripts/mbzs/149-economia-primero-bach-ies.mbz 33
moosh course-config-set course 258 shortname economia-primero-bach
moosh course-config-set course 258 fullname "Economía 1º Bach."

moosh course-restore /init-scripts/mbzs/151-griego-primero-bach-ies.mbz 33
moosh course-config-set course 259 shortname griego-primero-bach
moosh course-config-set course 259 fullname "Griego I 1º Bach."

moosh course-restore /init-scripts/mbzs/153-arte-primero-bach-ies.mbz 27
moosh course-config-set course 260 shortname arte-primero-bach
moosh course-config-set course 260 fullname "Fundamentos del Arte I 1º"

moosh course-restore /init-scripts/mbzs/156-audiovisual-primero-bach-ies.mbz 27
moosh course-config-set course 261 shortname audiovisual-primero-bach
moosh course-config-set course 261 fullname "Cultura Audiovisual I 1º"

moosh course-restore /init-scripts/mbzs/157-volumen-primero-bach-ies.mbz 27
moosh course-config-set course 262 shortname volumen-primero-bach
moosh course-config-set course 262 fullname "Volumen 1º"

moosh course-restore /init-scripts/mbzs/158-artistico-primero-bach-ies.mbz 27
moosh course-config-set course 263 shortname artistico-primero-bach
moosh course-config-set course 263 fullname "Dibujo Artístico I 1º"

moosh course-restore /init-scripts/mbzs/159-tecnico-primero-bach-ies.mbz 27
moosh course-config-set course 264 shortname tecnico-primero-bach
moosh course-config-set course 264 fullname "Dibujo Técnico I 1º"

moosh course-restore /init-scripts/mbzs/161-musical-primero-bach-ies.mbz 27
moosh course-config-set course 265 shortname musical-primero-bach
moosh course-config-set course 265 fullname "Lenguaje y Práctica Musical 1º"

moosh course-restore /init-scripts/mbzs/162-analisis-primero-bach-ies.mbz 27
moosh course-config-set course 266 shortname analisis-primero-bach
moosh course-config-set course 266 fullname "Análisis musical I 1º"

moosh course-restore /init-scripts/mbzs/163-talleres-primero-bach-ies.mbz 27
moosh course-config-set course 267 shortname talleres-primero-bach
moosh course-config-set course 267 fullname "Talleres artísticos 1º "

moosh course-restore /init-scripts/mbzs/164-efisica-segundo-bach-ies.mbz 25
moosh course-config-set course 268 shortname efisica-segundo-bach
moosh course-config-set course 268 fullname "Educación Física y vida activa 2º"

moosh course-restore /init-scripts/mbzs/166-lengua-segundo-bach-ies.mbz 25
moosh course-config-set course 269 shortname lengua-segundo-bach
moosh course-config-set course 269 fullname "Lengua Castellana y Literatura II 2º"

moosh course-restore /init-scripts/mbzs/167-filosofia-segundo-bach-ies.mbz 25
moosh course-config-set course 270 shortname filosofia-segundo-bach
moosh course-config-set course 270 fullname "Historia de la Filosofía 2º"

moosh course-restore /init-scripts/mbzs/168-english-segundo-bach-ies.mbz 25
moosh course-config-set course 271 shortname english-segundo-bach
moosh course-config-set course 271 fullname "English II 2º"

moosh course-restore /init-scripts/mbzs/169-francais-segundo-bach-ies.mbz 25
moosh course-config-set course 272 shortname francais-segundo-bach
moosh course-config-set course 272 fullname "Français II 2º"

moosh course-restore /init-scripts/mbzs/170-deutsch-segundo-bach-ies.mbz 25
moosh course-config-set course 273 shortname deutsch-segundo-bach
moosh course-config-set course 273 fullname "Deutsch II 2º"

moosh course-restore /init-scripts/mbzs/171-tic1-segundo-bach-ies.mbz 25
moosh course-config-set course 274 shortname tic1-segundo-bach
moosh course-config-set course 274 fullname "Tecnologías de la Información y la Comunicación II 2º"

moosh course-restore /init-scripts/mbzs/173-ciudadania-segundo-bach-ies.mbz 25
moosh course-config-set course 275 shortname ciudadania-segundo-bach
moosh course-config-set course 275 fullname "Pensamiento, Sociedad y Ciudadanía 2º"

moosh course-restore /init-scripts/mbzs/174-aragon-segundo-bach-ies.mbz 25
moosh course-config-set course 276 shortname aragon-segundo-bach
moosh course-config-set course 276 fullname "Historia y Cultura de Aragón II 2º"

moosh course-restore /init-scripts/mbzs/175-aragones-segundo-bach-ies.mbz 25
moosh course-config-set course 277 shortname aragones-segundo-bach
moosh course-config-set course 277 fullname "Aragonés 2º"

moosh course-restore /init-scripts/mbzs/176-catalan-segundo-bach-ies.mbz 25
moosh course-config-set course 278 shortname catalan-segundo-bach
moosh course-config-set course 278 fullname "Catalán 2º"

moosh course-restore /init-scripts/mbzs/177-tutoria-segundo-bach-ies.mbz 25
moosh course-config-set course 279 shortname tutoria-segundo-bach
moosh course-config-set course 279 fullname "Tutoría 2º"

moosh course-restore /init-scripts/mbzs/201-hespana-segundo-bach-ies.mbz 25
moosh course-config-set course 280 shortname hespana-segundo-bach
moosh course-config-set course 280 fullname "Historia de España 2º BACH"

moosh course-restore /init-scripts/mbzs/206-psicologia-segundo-bach-ies.mbz 25
moosh course-config-set course 281 shortname psicologia-segundo-bach
moosh course-config-set course 281 fullname "Psicología 2º"

moosh course-restore /init-scripts/mbzs/207-administracion-segundo-bach-ies.mbz 25
moosh course-config-set course 282 shortname administracion-segundo-bach
moosh course-config-set course 282 fullname "Fundamentos de Administración y Gestión 2º"

moosh course-restore /init-scripts/mbzs/208-proyecto-segundo-bach-ies.mbz 25
moosh course-config-set course 283 shortname proyecto-segundo-bach
moosh course-config-set course 283 fullname "Proyecto de Investigación e Innovación Integrado 2º"

moosh course-restore /init-scripts/mbzs/212-danza-segundo-bach-ies.mbz 25
moosh course-config-set course 284 shortname danza-segundo-bach
moosh course-config-set course 284 fullname "Historia de la Música y de la Danza 2º"

moosh course-restore /init-scripts/mbzs/185-matematicasi-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 285 shortname matematicasi-segundo-bach-ciencias
moosh course-config-set course 285 fullname "Matemáticas II 2º"

moosh course-restore /init-scripts/mbzs/186-fisica-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 286 shortname fisica-segundo-bach-ciencias
moosh course-config-set course 286 fullname "Física 2º"

moosh course-restore /init-scripts/mbzs/187-biologia-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 287 shortname biologia-segundo-bach-ciencias
moosh course-config-set course 287 fullname "Biología 2º"

moosh course-restore /init-scripts/mbzs/188-tecnologia-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 288 shortname tecnologia-segundo-bach-ciencias
moosh course-config-set course 288 fullname "Tecnología Industrial 2º"

moosh course-restore /init-scripts/mbzs/202-geologia-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 289 shortname geologia-segundo-bach-ciencias
moosh course-config-set course 289 fullname "Geología 2º"

moosh course-restore /init-scripts/mbzs/203-dibujo-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 290 shortname dibujo-segundo-bach-ciencias
moosh course-config-set course 290 fullname "Dibujo Técnico 2º"

moosh course-restore /init-scripts/mbzs/204-quimica-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 291 shortname quimica-segundo-bach-ciencias
moosh course-config-set course 291 fullname "Química 2º"

moosh course-restore /init-scripts/mbzs/205-medio-segundo-bach-ciencias-ies.mbz 31
moosh course-config-set course 292 shortname medio-segundo-bach-ciencias
moosh course-config-set course 292 fullname "Ciencias de la Tierra y del Medio Ambiente 2º"

moosh course-restore /init-scripts/mbzs/189-matematicasccss-segundo-bach-humanidades-ies.mbz 34
moosh course-config-set course 293 shortname matematicasccss-segundo-bach-humanidades
moosh course-config-set course 293 fullname "Matemáticas aplicadas a las Ciencias Sociales II 2º"

moosh course-restore /init-scripts/mbzs/190-latin-segundo-bach-humanidades-ies.mbz 34
moosh course-config-set course 294 shortname latin-segundo-bach-humanidades
moosh course-config-set course 294 fullname "Latín II 2º"

moosh course-restore /init-scripts/mbzs/192-griego-segundo-bach-humanidades-ies.mbz 34
moosh course-config-set course 295 shortname griego-segundo-bach-humanidades
moosh course-config-set course 295 fullname "Griego II 2º"

moosh course-restore /init-scripts/mbzs/209-empresa-segundo-bach-humanidades-ies.mbz 34
moosh course-config-set course 296 shortname empresa-segundo-bach-humanidades
moosh course-config-set course 296 fullname "Economía de la Empresa 2º"

moosh course-restore /init-scripts/mbzs/210-geografia-segundo-bach-humanidades-ies.mbz 34
moosh course-config-set course 297 shortname geografia-segundo-bach-humanidades
moosh course-config-set course 297 fullname "Geografía 2º"

moosh course-restore /init-scripts/mbzs/211-arte-segundo-bach-humanidades-ies.mbz 34
moosh course-config-set course 298 shortname arte-segundo-bach-humanidades
moosh course-config-set course 298 fullname "Historia del Arte 2º"

moosh course-restore /init-scripts/mbzs/193-arte-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 299 shortname arte-segundo-bach-artes
moosh course-config-set course 299 fullname "Fundamentos del Arte II 2º"

moosh course-restore /init-scripts/mbzs/194-audiovisual-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 300 shortname audiovisual-segundo-bach-artes
moosh course-config-set course 300 fullname "Cultura Audiovisual 2º"

moosh course-restore /init-scripts/mbzs/196-artistico-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 301 shortname artistico-segundo-bach-artes
moosh course-config-set course 301 fullname "Dibujo Artístico II 2º"

moosh course-restore /init-scripts/mbzs/197-tecnico-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 302 shortname tecnico-segundo-bach-artes
moosh course-config-set course 302 fullname "Dibujo Técnico II 2º"

moosh course-restore /init-scripts/mbzs/199-analisis-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 303 shortname analisis-segundo-bach-artes
moosh course-config-set course 303 fullname "Análisis musical 2º"

moosh course-restore /init-scripts/mbzs/214-escenicas-segundo-bac-artes-ies.mbz 28
moosh course-config-set course 304 shortname escenicas-segundo-bac-artes
moosh course-config-set course 304 fullname "Artes Escénicas 2º"

moosh course-restore /init-scripts/mbzs/215-diseno-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 305 shortname diseno-segundo-bach-artes
moosh course-config-set course 305 fullname "Diseño 2º"

moosh course-restore /init-scripts/mbzs/216-imagen-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 306 shortname imagen-segundo-bach-artes
moosh course-config-set course 306 fullname "Imagen y Sonido"

moosh course-restore /init-scripts/mbzs/217-edicion-segundo-bach-artes-ies.mbz 28
moosh course-config-set course 307 shortname edicion-segundo-bach-artes
moosh course-config-set course 307 fullname "Técnicas de edición gráfico-plástica 2º"
...
moosh course-config-set category 22 format topics
moosh course-config-set category 24 format topics
...
moosh course-config-set category 30 format topics
